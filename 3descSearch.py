...
eval_dataset = TextDataset(tokenizer, "evaldataset/source.txt")
...
qurey_set = TextDataset(tokenizer, "evaldataset/qurey.txt")
qurey_sampler = SequentialSampler(qurey_set)
qurey = DataLoader(qurey_set, sampler=qurey_sampler, batch_size=128)
...
scores=np.matmul(nl_vecs,source_vecs.T)
sort_ids=np.argsort(scores, axis=-1, kind='quicksort', order=None)[:,::-1]

with open("evaldataset/desc.jsonl", 'w') as f:
