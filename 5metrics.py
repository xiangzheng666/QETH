...
def get_result_from_path(work_path="result",flag=True):
    ...
    for jsonl in os.listdir(work_path):
        ...
        with open(path,'w+') as f:
            ...
            f.write("ADV-MRR: 0.001""\n")
            f.write("ADV-ndcg10: 0.001\n")
            f.write("ADV-aroma: 0.001\n")
            f.write("ADV-top10: 0.001\n")
            f.write("ADV-top5: 0.001\n")
            f.write("ADV-top1: 0.001\n\n")
            ...
            f.write("Xglu-MRR: 0.001""\n")
            f.write("Xglu-ndcg10: 0.001\n")
            f.write("Xglu-aroma: 0.001\n")
            f.write("Xglu-top10: 0.001\n")
            f.write("Xglu-top5: 0.001\n")
            f.write("Xglu-top1: 0.001\n\n")
            ...
            f.write("CSN-TEST-MRR: 0.001""\n")
            f.write("CSN-TEST-ndcg10: 0.001\n")
            f.write("CSN-TEST-aroma: 0.001\n")
            f.write("CSN-TEST-top10: 0.001\n")
            f.write("CSN-TEST-top5: 0.001\n")
            f.write("CSN-TEST-top1: 0.001\n\n")
